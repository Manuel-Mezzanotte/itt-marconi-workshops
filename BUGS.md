...
| BUG-05 | [#5](https://github.com/Manuel-Mezzanotte/itt-marconi-workshops/issues/5) | Revisione del formato timestamp del T-03 | impl | REQ-USR-10, design UserService | Lo slicing [:-3] elimina tre cifre dei microsecondi; il test del formato replica la precisione errata | Nove casi rossi prima del fix Kiro Default/Vibe, poi formato a sei cifre e 324 test verdi | Branch fix/user-5; collaudo finale pendente |
